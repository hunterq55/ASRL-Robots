...
thetaC(1)=180 - acosd(((pa3H^2)^2+(DH2(4)^2)-(pa2H(1)^2))/(2*DH2(4)*pa3H)) + 90 - thetaE;
thetaC(2)=180 - acosd(((pa3H^2)^2+(DH2(4)^2)-(pa2H(2)^2))/(2*DH2(4)*pa3H)) + 90 - thetaE;
